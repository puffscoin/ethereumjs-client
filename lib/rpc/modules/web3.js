...
const { addHexPrefix, keccak256 } = require('puffscoinjs-util')
...
class Web3 {
  ...
  clientVersion (params, cb) {
    ...
    const puffsJsVersion = `PuffscoinJS/${packageVersion}/${platform()}/node${version.substring(
      1
    )}`
    cb(null, puffsJsVersion)
  }
